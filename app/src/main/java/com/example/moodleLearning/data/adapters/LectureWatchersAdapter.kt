...
class LectureWatchersAdapter(val context: Context) :
    RecyclerView.Adapter<LectureWatchersAdapter.ViewHolder>() {
    private var list = mutableListOf<User>()

    class ViewHolder(val binding: LectureWatchersItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LectureWatchersItemBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.studentName.text =
